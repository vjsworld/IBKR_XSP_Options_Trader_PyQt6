...
class IBapi(EWrapper, EClient):
    ...
    def error(self, reqId, errorTime, errorCode, errorString, *args):
        if reqId != -1:
    ...
    def fetch_historical_data(self, reqId):
        try:
            ...
            self.reqHistoricalData(reqId, option, '', '5 D', '15 secs', 'MIDPOINT', 0, 1, False, [])
            time.sleep(1)
...
def main():
    ...
    app.reqHistoricalData(500, app.ticker, '', '5 D', '1 min', 'TRADES', 0, 1, False, [])
    time.sleep(2)
    #app.disconnect()
